        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(mockPersistence.load).toBeCalledWith(analytics_1.BotAnalytics.StorageKey);
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    it('uploads sync data if observation period of local data is long enough', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.sent();
                    expect(mockPersistence.save).toBeCalledWith(analytics_1.BotAnalytics.StorageKey, {
